...
- [ ] asdasdf asfda a asdfasfd asfd sadf asdf sfa faf asd fsadf asfd asdfa saf  asdasdf asfda a asdfasfd asfd sadf asdf sfa faf asd fsadf asfd asdfa saf XXXXXXXXXX
- [ ] asaafd
...
This is some basic increment that
<script input="range" value="12" default="12" output="startPoint">
@input
</script> you can manipulate. It's value is published on topic `startPoint`. Within the script below, this value is imported and added to the first data-series.

<script runOnce style="display: inline-block; width: 100%">

var start = @input(`startPoint`) * 100
    ...
    series: [
        {
            ...
            data: [start+120, start+132, start+101, start+134, start+90, start+230, start+210]
        },
        {
            name: '联盟广告',
            type: 'line',
...
asdfasfdaf asfdasfdasd



# asdfads
dfgsdfgsdfg sdgfsdgf  asdasfdaf asfda  asdafdsfads asf as
...
# asdfas
<!--
@d1: <script input='checkbox' default='true'>@input</script>
-->
...
````````````````
 +------------------------------------+                +-------------------------------------+
 | " {{1}}$$                        " |                |""``` js     +p1                   ""|
 | " \sum_{i=1}^\infty\frac{1}{n^2} " |                |""alert("hello World");            ""|
 | "      =\frac{\pi^2}{6}          " +-----"@d1    "->|""```                              ""|
 | " $$                             " |                |""```js      +p2                   ""|
 |                                    |                |""333*12                           ""|
 |                                    |                |""```                              ""|
...
ssss "a <script input='range' default='12'>@input</script> b" nnnnn
     "             "
     "             "

````````````````

<script>`LIASCRIPT: this is a{1}{2}`</script>


{{3}}
<lia-formula displaymode="true" formula="a+b">a+b</lia-formula>
...
<!-- data-marker="0 0 0 100 error screenline;2 0 4 200 log;6 12 6 33 rgba(55,255,100,0.5) text" data-showGutter="true"
data-theme="chaos"
data-readOnly="false" -->
```
this will be red
