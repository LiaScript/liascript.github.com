...
})({"11zV3":[function(require,module,exports) {
var HMR_HOST = null;var HMR_PORT = 1234;var HMR_SECURE = false;var HMR_ENV_HASH = "d751713988987e9331980363e24189ce";module.bundle.HMR_BUNDLE_ID = "b782eb9c6ec4e87f3d2eac5b885d337e";/* global HMR_HOST, HMR_PORT, HMR_ENV_HASH, HMR_SECURE */
...
},{}],"5svVM":[function(require,module,exports) {
require('katex/dist/katex.min.css');
var _katex = require('katex');
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
var _katexDefault = _parcelHelpers.interopDefault(_katex);
customElements.define('lia-formula', class extends HTMLElement {
  ...
  render() {
    if (this.formula_ && this.span) {
      try {
        _katexDefault.default.render(this.formula_, this.span, {
          throwOnError: false,
...
},{"katex/dist/katex.min.css":"14x1o","katex":"49sNF","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"14x1o":[function() {},{}],"49sNF":[function(require,module,exports) {
var define;
    ...
    function (module, __webpack_exports__, __webpack_require__) {
      ...
      */
      ...
      for (var symbols_i3 = 0; symbols_i3 < letters.length; symbols_i3++) {
        ...
        symbols_wideChar = String.fromCharCode(0xD835, 0xDC00 + symbols_i3);
        // A-Z a-z bold
        ...
        symbols_wideChar = String.fromCharCode(0xD835, 0xDC34 + symbols_i3);
        // A-Z a-z italic
        defineSymbol(symbols_math, main, mathord, _ch3, symbols_wideChar);
        defineSymbol(symbols_text, main, symbols_textord, _ch3, symbols_wideChar);
        symbols_wideChar = String.fromCharCode(0xD835, 0xDC68 + symbols_i3);
        // A-Z a-z bold italic
        defineSymbol(symbols_math, main, mathord, _ch3, symbols_wideChar);
        defineSymbol(symbols_text, main, symbols_textord, _ch3, symbols_wideChar);
        symbols_wideChar = String.fromCharCode(0xD835, 0xDD04 + symbols_i3);
        // A-Z a-z Fractur
        defineSymbol(symbols_math, main, mathord, _ch3, symbols_wideChar);
        defineSymbol(symbols_text, main, symbols_textord, _ch3, symbols_wideChar);
        symbols_wideChar = String.fromCharCode(0xD835, 0xDDA0 + symbols_i3);
        // A-Z a-z sans-serif
        defineSymbol(symbols_math, main, mathord, _ch3, symbols_wideChar);
        defineSymbol(symbols_text, main, symbols_textord, _ch3, symbols_wideChar);
        symbols_wideChar = String.fromCharCode(0xD835, 0xDDD4 + symbols_i3);
        // A-Z a-z sans bold
        defineSymbol(symbols_math, main, mathord, _ch3, symbols_wideChar);
        defineSymbol(symbols_text, main, symbols_textord, _ch3, symbols_wideChar);
        symbols_wideChar = String.fromCharCode(0xD835, 0xDE08 + symbols_i3);
        // A-Z a-z sans italic
        defineSymbol(symbols_math, main, mathord, _ch3, symbols_wideChar);
        defineSymbol(symbols_text, main, symbols_textord, _ch3, symbols_wideChar);
        symbols_wideChar = String.fromCharCode(0xD835, 0xDE70 + symbols_i3);
        // A-Z a-z monospace
        defineSymbol(symbols_math, main, mathord, _ch3, symbols_wideChar);
        defineSymbol(symbols_text, main, symbols_textord, _ch3, symbols_wideChar);
        if (symbols_i3 < 26) {
          ...
          symbols_wideChar = String.fromCharCode(0xD835, 0xDD38 + symbols_i3);
          // A-Z double struck
          defineSymbol(symbols_math, main, mathord, _ch3, symbols_wideChar);
          defineSymbol(symbols_text, main, symbols_textord, _ch3, symbols_wideChar);
          symbols_wideChar = String.fromCharCode(0xD835, 0xDC9C + symbols_i3);
          // A-Z script
          defineSymbol(symbols_math, main, mathord, _ch3, symbols_wideChar);
          defineSymbol(symbols_text, main, symbols_textord, _ch3, symbols_wideChar);
        }
      ...
      symbols_wideChar = String.fromCharCode(0xD835, 0xDD5C);
      // k double struck
      ...
      for (var symbols_i4 = 0; symbols_i4 < 10; symbols_i4++) {
        ...
        symbols_wideChar = String.fromCharCode(0xD835, 0xDFCE + symbols_i4);
        // 0-9 bold
        ...
        symbols_wideChar = String.fromCharCode(0xD835, 0xDFE2 + symbols_i4);
        // 0-9 sans serif
        defineSymbol(symbols_math, main, mathord, _ch4, symbols_wideChar);
        defineSymbol(symbols_text, main, symbols_textord, _ch4, symbols_wideChar);
        symbols_wideChar = String.fromCharCode(0xD835, 0xDFEC + symbols_i4);
        // 0-9 bold sans
        defineSymbol(symbols_math, main, mathord, _ch4, symbols_wideChar);
        defineSymbol(symbols_text, main, symbols_textord, _ch4, symbols_wideChar);
        symbols_wideChar = String.fromCharCode(0xD835, 0xDFF6 + symbols_i4);
        // 0-9 monospace
        defineSymbol(symbols_math, main, mathord, _ch4, symbols_wideChar);
        defineSymbol(symbols_text, main, symbols_textord, _ch4, symbols_wideChar);
      }
      ...
      */
      var delimiter_makeStackedDelim = function makeStackedDelim(delim, heightTotal, center, options, mode, classes) {
        ...
        var shiftOfExtraElement = (repeatCount + 1) * 0.005 - repeatHeightTotal;
      ...
      var Parser_Parser = /*#__PURE__*/(function () {
        ...
        */
        _proto.handleSupSubscript = function handleSupSubscript(name) {
          ...
          this.consume();
          var group = this.parseGroup(name, false, Parser.SUPSUB_GREEDINESS, undefined, undefined, true);
        ...
        optional, raw) {
          ...
          var nested = 0;
          // allow nested braces in raw string group
...
},{}]},["11zV3","5svVM"], "5svVM", "parcelRequirebcba")

//# sourceMappingURL=index.885d337e.js.map
