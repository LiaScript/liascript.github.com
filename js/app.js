										...
										return function (k) {
											return function (l) {
												return function (m) {
													return function (n) {
														return function (o) {
															return {script: a, error: b, mode: c, slides: d, current_slide: e, show_contents: f, quiz_model: g, code_model: h, effect_model: i, index_model: j, survey_model: k, narator: l, silent: m, theme: n, theme_light: o};
														};
													};
												};
											};
				...
				case 'Speak':
					...
					if (((_p2.ctor === '_Tuple2') && (_p2._0.ctor === 'Just')) && (_p2._1 === false)) {
						return {
							...
							_1: A3(_user$project$Tts_Responsive$speak, _user$project$Lia_Effect_Update$TTS, model.narator, _p2._0._0),
							_2: false
						};
					} else {
	...
	function (msg, model) {
		...
		while (true) {
			...
			switch (_p1.ctor) {
				...
				case 'UpdateEffect':
					var _p9 = A2(_user$project$Lia_Effect_Update$update, _p1._0, model.effect_model);
					var effect_model = _p9._0;
					var cmd = _p9._1;
					return {
						ctor: '_Tuple3',
						_0: _elm_lang$core$Native_Utils.update(
				...
				default:
					var _p10 = A2(_user$project$Lia_Quiz_Update$update, _p1._0, model.quiz_model);
					var quiz_model = _p10._0;
					var info = _p10._1;
					return {
						ctor: '_Tuple3',
						_0: _elm_lang$core$Native_Utils.update(
...
var _user$project$Lia_Effect_View$comment = F7(
	function (show_inline, silent, msg, model, viewer, idx, elements) {
		return show_inline ? A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('lia-effect-comment'),
				_1: {ctor: '[]'}
			},
			A2(
				_elm_lang$core$List$append,
