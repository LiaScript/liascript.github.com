...
Try it live — drag to orbit, scroll to zoom:
...
See the RGB axes rendered in 3D — drag to inspect from any angle:
...
```html @AFRAME.scene
<a-scene>
<!-- Move the whole coordinate system in front of the camera -->
  <a-entity position="0 0 -4">
    ...
    <a-box position="0 0 1" scale="0.05 0.05 2" color="blue"></a-box>
    <!-- Tip markers -->
    <a-sphere position="2 0 0" radius="0.12" color="red"></a-sphere>
    <a-sphere position="0 2 0" radius="0.12" color="green"></a-sphere>
    <a-sphere position="0 0 2" radius="0.12" color="blue"></a-sphere>
  </a-entity>
  <a-sky color="#222"></a-sky>
  <!-- Explicit camera -->
